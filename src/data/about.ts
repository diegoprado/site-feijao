...
export const aboutList2 = [
  [
    'Promover a prática esportiva como ferramenta de inclusão social e qualidade de vida.',
    'Construir uma cidade mais acessível e segura para pedestres, ciclistas e transporte público.',
  ],
  [
    'Garantir políticas públicas que promovam a saúde, a segurança e o bem-estar da população.',
  ],
];
